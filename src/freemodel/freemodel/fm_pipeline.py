...
class FMPipeline(Node):
    """
    Pure logger — records (Ek, Uk, Ek1, Uk1) pairs from leader.
    Optional: used for analysis/verification only.
    Main learning uses fm_offline_spsa.py (pure math, no Gazebo).
    """
    def __init__(self):
    ...
    def save_and_exit(self):
        ...
        meta = {'q_des': self.q_des.tolist(), 'joints': self.joints, 'dt': self.dt, 'N': self.N}
